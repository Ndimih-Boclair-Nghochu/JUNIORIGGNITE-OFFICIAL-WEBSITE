    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-page relative py-20 text-center">
          <Reveal className="mx-auto max-w-3xl">
            <span className="eyebrow"><Sparkles className="h-4 w-4 text-accent-500" /> About {SITE.name}</span>
      ...
      <section className="bg-slate-50 py-20">
        <div className="container-page grid items-center gap-12 lg:grid-cols-2">
          <Reveal>
            <span className="eyebrow"><Target className="h-4 w-4 text-accent-500" /> Our mission</span>
